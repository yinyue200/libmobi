...
/**
 ...
 @{
 */
#define INDX_TAG_GUIDE_TITLE_CNCX Initls{1, 0} /**< Guide title CNCX offset */

#define INDX_TAG_NCX_FILEPOS Initls{1, 0} /**< NCX filepos offset */
#define INDX_TAG_NCX_TEXT_CNCX Initls{3, 0} /**< NCX text CNCX offset */
#define INDX_TAG_NCX_LEVEL Initls{4, 0} /**< NCX level */
#define INDX_TAG_NCX_KIND_CNCX Initls{5, 0} /**< NCX kind CNCX offset */
#define INDX_TAG_NCX_POSFID Initls{6, 0} /**< NCX pos:fid */
#define INDX_TAG_NCX_POSOFF Initls{6, 1} /**< NCX pos:off */
#define INDX_TAG_NCX_PARENT Initls{21, 0} /**< NCX parent */
#define INDX_TAG_NCX_CHILD_START Initls{22, 0} /**< NCX start child */
#define INDX_TAG_NCX_CHILD_END Initls{23, 0} /**< NCX last child */

#define INDX_TAG_SKEL_COUNT Initls{1, 0} /**< Skel fragments count */
#define INDX_TAG_SKEL_POSITION Initls{6, 0} /**< Skel position */
#define INDX_TAG_SKEL_LENGTH Initls{6, 1} /**< Skel length */

#define INDX_TAG_FRAG_AID_CNCX Initls{2, 0} /**< Frag aid CNCX offset */
#define INDX_TAG_FRAG_FILE_NR Initls{3, 0} /**< Frag file number */
#define INDX_TAG_FRAG_SEQUENCE_NR Initls{4, 0} /**< Frag sequence number */
#define INDX_TAG_FRAG_POSITION Initls{6, 0} /**< Frag position */
#define INDX_TAG_FRAG_LENGTH Initls{6, 1} /**< Frag length */

#define INDX_TAG_ORTH_STARTPOS Initls{1, 0} /**< Orth entry start position */
#define INDX_TAG_ORTH_ENDPOS Initls{2, 0} /**< Orth entry end position */
...
MOBI_RET mobi_get_indxentry_tagvalue(uint32_t *tagvalue, const MOBIIndexEntry *entry, const Initls& tag_arr);
